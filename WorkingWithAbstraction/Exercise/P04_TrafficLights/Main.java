package WorkingWithAbstraction.Exercise.P04_TrafficLights;
...
public class Main {
    public static void main(String[] args) {
        ...
        Signals[] signals = Arrays.stream(scanner.nextLine().split("\\s+")).map(Signals::valueOf).toArray(Signals[]::new);
